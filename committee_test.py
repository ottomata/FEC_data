...
try:
    api_response = disbusements_api.schedules_schedule_b_get(api_key, min_date=min_date, committee_id=committee_id, sort=sort, two_year_transaction_period=two_year_transaction_period)
    pprint(api_response)
